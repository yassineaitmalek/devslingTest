...
public class DateUtility {
  ...
  public static LocalDate convertDateToLocalDate(Date date) {
    ...
    return Optional.ofNullable(date)
        .map(e -> LocalDateTime.ofInstant(e.toInstant(), zone).toLocalDate())
        .orElse(null);
  ...
  public static Date convertLocalDateToDate(LocalDate localDate) {
    ...
    return Optional.ofNullable(localDate)
        .map(e -> Date.from(e.atStartOfDay(zone).toInstant()))
        .orElse(null);
  ...
  public static String nowDateTimeString2String() {

    return String.valueOf(nowDateTime().getHour()) + String.valueOf(nowDateTime().getMinute())
        + String.valueOf(nowDateTime().getSecond()) + String.valueOf(nowDateTime().getDayOfMonth())
        + String.valueOf(nowDateTime().getMonthValue()) + String.valueOf(nowDateTime().getYear());
